const ConstFAQs = [
  {
    ...
    answer:
      "The Mustard Seed Autism Trust team will aim to get back to you within 24 hours.",
  },
  {
    id: 2,
    question: "Is there a paid for service available?",
    answer:
      `Yes! You can find out more about our paid for service by visiting Branches. Click the link below to find out more.`,
    link: "https://mustardseedautism.co.uk/branches/",
  },
  {
    id: 3,
    question: "What Information do I need to provide?",
    answer: "You will need to provide your name, email address and a brief description of your enquiry.",
  },
  {
    id: 4,
    question: "What happens if I don't get a space?",
    answer: "If you don't get a space, you will be added to the waitlist and we will contact you if a space becomes available.",
  },
];
          ...
          {ConstFAQs.map((faq) => (
            <div key={faq.id} className="py-8 first:pt-0 last:pb-0 lg:grid lg:grid-cols-12 lg:gap-8">
              ...
              <dd className="mt-4 lg:col-span-7 lg:mt-0">
                ...
                {faq.link && (
                  <a href={faq.link} target="_blank" className="text-blue-500 hover:underline">
                    Learn more
                  </a>
                )}
              </dd>
