...
const PostalCodeValidator = ({
  ...
  return (
    <div className="text-black">
      <label
        className="text-sm font-medium text-gray-900 col-span-3"
        htmlFor="postalCode"
      >
        Postal Code:
      </label>
      <div className="grid grid-cols-12">
        <input
          required
          className="uppercase border border-slate-400 rounded col-span-8 outline-1"
          type="text"
          value={postalCode}
          ...
          <p>
            {isValidPostCode ? (
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-8 stroke-green-600 col-span-2"
              >
                <path
                  strokeLinecap="round"
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-8 stroke-red-600 col-span-2"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
